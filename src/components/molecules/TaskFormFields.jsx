      ...
      {isSubtask && parentTaskTitle && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
          <div className="flex items-center space-x-2 text-sm text-blue-700">
            ...
            <span>Creating subtask for: <strong>{parentTaskTitle}</strong></span>
          </div>
        </div>
      )}
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            onClick={() => onGenerateDescription && onGenerateDescription(formData.title_c)}
            disabled={!formData.title_c?.trim() || isGeneratingDescription}
            className="text-xs"
          >
...
<Input
      ...
      {/* Recurring Task Section - Hidden for subtasks */}
      {!isSubtask && (
